...
specifically designed for finding global maxima.

Key Features:
- Multiple acquisition functions for maximization
...
class Global_max(object):
    ...
    def EI(self, T=None):
        ...
        It balances exploration and exploitation by considering both the predicted
